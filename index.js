...
const serviceAccountKeyFile = "./qm-bot-427215-2ee6610e3598.json";
...
async function appendValues(num, m, amo) {
	...
	try {
		...
		spreadsheetId: '1OGXhJlTAuNQX19w1-G3XIs8aYhf7BMYXTsmmaDAsGRE',
	...
	if (interaction.isChatInputCommand()) {
		...
		if (interaction.commandName === 'requestinfo') {
			try {
				...
				//await interaction.reply({ content: `Outputting requests`, ephemeral: true });
				var newList = [];
